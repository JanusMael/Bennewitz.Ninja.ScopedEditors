...
public static class CopyValue
{
    ...
    /// <summary>Identifies the <c>IsEnabled</c> attached property.</summary>
    ...
    /// <summary>Reads the <c>IsEnabled</c> attached property.</summary>
    /// <param name="dg">The DataGrid to read it from.</param>
    ...
    /// <summary>Writes the <c>IsEnabled</c> attached property.</summary>
    /// <param name="dg">The DataGrid to write it on.</param>
