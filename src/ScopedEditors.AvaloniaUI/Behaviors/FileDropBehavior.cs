...
namespace Bennewitz.Ninja.ScopedEditors.AvaloniaUI.Behaviors;
...
public static class FileDrop
{
    ...
    /// <summary>Reads the <c>AllowedExtensions</c> attached property.</summary>
    /// <param name="c">The Control to read it from.</param>
    ...
    /// <summary>Writes the <c>AllowedExtensions</c> attached property.</summary>
    /// <param name="c">The Control to write it on.</param>
    ...
    /// <summary>Reads the <c>DropCommand</c> attached property.</summary>
    /// <param name="c">The Control to read it from.</param>
    /// <returns>The current value.</returns>
    ...
    /// <summary>Writes the <c>DropCommand</c> attached property.</summary>
    /// <param name="c">The Control to write it on.</param>
    /// <param name="value">The value to set.</param>
