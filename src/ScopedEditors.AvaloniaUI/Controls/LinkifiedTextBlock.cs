...
using Bennewitz.Ninja.ScopedEditors.AvaloniaUI.Helpers;
using Bennewitz.Ninja.ScopedEditors.Messages;
using CommunityToolkit.Mvvm.Messaging;

namespace Bennewitz.Ninja.ScopedEditors.AvaloniaUI.Controls;
...
public sealed partial class LinkifiedTextBlock : TextBlock
{
    ...
    /// <summary>The source text to linkify. Set this rather than <see cref="TextBlock.Text"/>,
    /// which clears the generated inlines on the next layout pass.</summary>
    ...
    /// <summary>Create a new <see cref="LinkifiedTextBlock"/>.</summary>
