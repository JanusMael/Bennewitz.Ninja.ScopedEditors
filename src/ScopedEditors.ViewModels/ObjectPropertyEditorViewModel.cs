...
public partial class ObjectPropertyEditorViewModel : PropertyEditorViewModel, IChildEditorHost
{
    ...
    /// <summary>Create an editor for an object-valued property and adopt its child editors.</summary>
    /// <param name="schema">Describes the object being edited.</param>
    /// <param name="editingScope">The scope edits are written to.</param>
    /// <param name="children">One editor per modelled property. Their lifetime matches this one.</param>
    /// <param name="workspace">Optional workspace, used to preserve unmodelled keys.</param>
    ...
    /// <summary>The child editors, one per modelled property of the object.</summary>
