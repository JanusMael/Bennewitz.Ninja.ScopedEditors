...
public partial class StringArrayPropertyEditorViewModel : PropertyEditorViewModel
{
    ...
    /// <summary>The editable items. Mutating this collection is what makes the value set.</summary>
    public ObservableCollection<string> Items { get; }

    /// <summary>True when this editor holds a value of its own (the collection is non-empty) rather than
